...
const int BOARD2_SIZE = 3;
const int BOARD_EDGE = 2;
/*
...
public:
   ...
   */
   ...
   inline static bool InBounds(int row, int col) {return row >= 0 && row < BOARD2_SIZE && col >= 0 && col < BOARD2_SIZE;}
   ...
   virtual bool IsFinished() const {
	   return mValue == 1 || mValue == -1 || GetMoveCount() == 9;  // winner if mValue is not zero
   }
...
private:
	...
	char mBoard[BOARD2_SIZE][BOARD2_SIZE];
   static char mWeights[BOARD2_SIZE][BOARD2_SIZE];
};
#endif